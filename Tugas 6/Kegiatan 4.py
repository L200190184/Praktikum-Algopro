...
>>> type(Aku[a])
<class 'int'>
>>> # elemen tuple Aku indeks ke 0(0 merupakan data dari variabel a) atau TahunLahir adalah 2000 dan merupakan data bertipe integer atau bilangan bulat
>>> Aku[a:4]
(2000, 73, 1.65, 184)
...
>>> Data[4][a:6]
'Alfian'
>>> # elemen list Data indeks ke-4 yang berisi Nama kemudian program akan menjadi Nama[a:6] dimana a berisi data 0 maka akan menjadi Nama[0:6] yang akan meampilkan elemen list indeks ke-0 hingga sebelum indeks ke-6 yaitu Alfian
>>> Data[0] = 'ok'; Data
['ok', 73, 1.65, 184, 'Alfian Makruf Nur Sholehudin']
